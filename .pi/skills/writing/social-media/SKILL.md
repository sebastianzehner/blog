...
name: social-media
description: >-
  Use this skill when writing platform-specific social media content—Twitter/X
  threads, LinkedIn posts, Instagram captions, or short-form content designed to
  drive engagement, shares, or follows. Trigger phrases: 'write a tweet about',
  'create a LinkedIn post', 'write an Instagram caption', 'write a thread'. Do
  NOT use for long-form articles or blog posts, or email newsletters.
version: 1.0.0
author: community
tags:
  - writing
