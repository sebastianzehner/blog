...
description: >-
  Use this skill when creating technical documentation, API references,
  installation guides, README files, or any content that explains how a system,
  tool, or process works to a technical audience. Trigger phrases: 'document
  this API', 'write a README', 'create a setup guide'. Do NOT use for marketing
  copy about a product or non-technical how-to content aimed at general
  audiences.
version: 1.0.0
author: community
tags:
