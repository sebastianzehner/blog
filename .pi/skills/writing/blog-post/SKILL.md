...
name: blog-post
description: >-
  Use this skill when writing blog posts, articles, or long-form web
  content—from quick how-to guides to in-depth opinion pieces. Trigger phrases:
  'write a blog post about', 'draft an article on', 'create a post for my blog'.
  Do NOT use for academic papers, news reporting, or content requiring real-time
  facts.
version: 1.0.0
author: community
tags:
...
But the _generation_ of the idea? That happens alone, usually in a moment of quiet.
